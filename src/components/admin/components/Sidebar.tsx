...
import { 
    ...
    DocumentTextIcon,
    // NOTA: Asegúrate de agregar/exportar estos 3 nuevos iconos en tu archivo src/components/Icons.tsx
...
const Sidebar: React.FC<SidebarProps> = ({ session, activeSection, onSectionChange, onBack }) => {
    ...
    // Asumimos que la gestión del Club Pilotos es para Admin y Super Admin
    ...
    const renderNavButton = (item: any) => (
        <button 
            ...
            className={`flex items-center justify-center lg:justify-start w-full gap-4 px-3 py-3 rounded-xl transition-all duration-200 group ${
